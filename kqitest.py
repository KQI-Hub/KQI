...
from kqitool import decode, generator_is_my_name, bitmap_to_chunkmap, chunkmap_to_bitmap, encode
...
open(f"{filename}.kqi", "wb").write(output)

inputf = open(f"{filename}.kqi", "rb").read()
bmp = decode(inputf)
